...
.controller('HelplineCtrl', function ($scope, $stateParams, $ionicModal, $ionicTabsDelegate) {
})

.controller('OneindiaawardCtrl', function ($scope, $stateParams, $ionicModal, $ionicTabsDelegate) {
})
